...
ActiveRecord::Schema[7.0].define(version: 2022_12_08_094357) do
  ...
  create_table "list_pets", force: :cascade do |t|
    t.bigint "pet_id", null: false
    t.bigint "user_id", null: false
    t.boolean "liked"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pet_id"], name: "index_list_pets_on_pet_id"
    t.index ["user_id"], name: "index_list_pets_on_user_id"
  end
  ...
  add_foreign_key "list_pets", "pets"
  add_foreign_key "list_pets", "users"
