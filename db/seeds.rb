...
# 1.times do
  #--------------------------------------------------Création des users--------------------------------------------------------------
    ...
    pet1 = Pet.create!(name: "Happy", age: "15/06/2015", race: "Border Collie", gender: "mâle", shelter_id: first_shelter.id, category: "chien", description: lorem, family_friendly: false, main_quality:"Sportif", is_adopted: false)
    ...
    pet2 = Pet.create!(name: "Shenzi", age: "17/07/2017", race: "Boxer", gender: "mâle", shelter_id: first_shelter.id, category: "chien", description: lorem, main_quality:"Affectueux", family_friendly: true, is_adopted: false)
    ...
    pet3 = Pet.create!(name: "Rexy", age: "06/01/2015", race: "Berger", gender: "femelle", shelter_id: second_shelter.id, category: "chien", description: lorem, main_quality:"Affectueux", family_friendly: true, is_adopted: false)
    ...
    pet4 = Pet.create!(name: "Joker", age: "26/03/2013", race: "Berger allemand", gender: "mâle", shelter_id: second_shelter.id, category: "chat", description: lorem, main_quality:"Joueur", family_friendly: false, is_adopted: false)
    ...
    pet5 = Pet.create!(name: "Aiguillette", age: "22/11/2019", race: "Boxer", gender: "femelle", shelter_id: first_shelter.id, category: "chien", description: lorem, main_quality:"Doux avec les enfants", family_friendly: true, is_adopted: false)
    ...
    pet6 = Pet.create!(name: "Django", age: "09/03/2014", race: "Berger belge Malinois", gender: "mâle", shelter_id: fourth_shelter.id, category: "chien", description: lorem, main_quality:"Sportif", family_friendly: true, is_adopted: false)
    ...
    pet7 = Pet.create!(name: "Lola", age: "21/06/2018", race: "Bichon", gender: "femelle", shelter_id: fourth_shelter.id, category: "chien", description: lorem, main_quality:"Espiègle", family_friendly: true, is_adopted: false)
    ...
    pet8 = Pet.create!(name: "Hagrid", age: "01/01/2020", race: "Berger", gender: "mâle", shelter_id: fourth_shelter.id, category: "chien", description: lorem, main_quality:"Doux avec les enfants", family_friendly: true, is_adopted: false)
    ...
    pet9 = Pet.create!(name: "Gamora", age: "20/03/2018", race: "Dogue", gender: "femelle", shelter_id: third_shelter.id, category: "chien", description: lorem, main_quality:"Espiègle", family_friendly: false, is_adopted: false)
    ...
    pet10 = Pet.create!(name: "Totor", age: "02/15/2016", race: "Berger belge malinois", gender: "mâle", shelter_id: third_shelter.id, category: "chien", description: lorem, main_quality:"Joueur", family_friendly: false, is_adopted: false)
  ...
  puts "Dogs created"
    ...
    pet1 = Pet.create!(name: "Flocon", age: "06/06/2018", race: "Européen", gender: "mâle", shelter_id: fifth_shelter.id, category: "chat", description: lorem, main_quality:"Espiègle", family_friendly: true, is_adopted: false)
    ...
    pet2 = Pet.create!(name: "Karma", age: "09/09/2019", race: "Européen", gender: "femelle", shelter_id: fifth_shelter.id, category: "chat", description: lorem, main_quality:"Affectueux", family_friendly: true, is_adopted: false)
    ...
    pet3 = Pet.create!(name: "Titeuf", age: "01/01/2008", race: "Européen", gender: "mâle", shelter_id: fifth_shelter.id, category: "chat", description: lorem, main_quality:"Espiègle", family_friendly: true, is_adopted: false)
    ...
    pet4 = Pet.create!(name: "Sacha", age: "01/10/2014", race: "Européen", gender: "mâle", shelter_id: fourth_shelter.id, category: "chat", description: lorem, main_quality:"Doux avec les enfants", family_friendly: true, is_adopted: false)
    ...
    pet5 = Pet.create!(name: "Tisha", age: "05/06/2022", race: "Européen", gender: "femelle", shelter_id: fifth_shelter.id, category: "chat", description: lorem, main_quality:"Joueur", family_friendly: true, is_adopted: false)
    ...
    pet6 = Pet.create!(name: "Papaya", age: "01/11/2020", race: "Européen", gender: "femelle", shelter_id: first_shelter.id, category: "chat", description: lorem, main_quality:"Joueur", family_friendly: true, is_adopted: false)
    ...
    pet7 = Pet.create!(name: "Yoshi", age: "01/06/2022", race: "Européen", gender: "mâle", shelter_id: first_shelter.id, category: "chat", description: lorem, main_quality:"Doux avec les enfants", family_friendly: true, is_adopted: false)
    ...
    pet8 = Pet.create!(name: "Musti", age: "01/12/2021", race: "Européen", gender: "femelle", shelter_id: second_shelter.id, category: "chat", description: lorem, main_quality:"Joueur",  family_friendly: true, is_adopted: false)
    ...
    pet9 = Pet.create!(name: "Diablo", age: "23/12/2015", race: "Européen", gender: "mâle", shelter_id: second_shelter.id, category: "chat", description: lorem, main_quality:"Affectueux", family_friendly: true, is_adopted: false)
    ...
    pet10 = Pet.create!(name: "Rouka", age: "25/07/2022", race: "Européen", gender: "mâle", shelter_id: third_shelter.id, category: "chat", description: lorem, main_quality:"Affectueux", family_friendly: true, is_adopted: false)
