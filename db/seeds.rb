...
# 1.times do
  #--------------------------------------------------Création des users--------------------------------------------------------------
    ...
    pet1 = Pet.create!(name: "Happy", age: "15/06/2015", race: "Border Collie", gender: "femelle", shelter_id: first_shelter.id, category: "chien", description: "Happy aime être dehors dans les grands espaces ! Elle adore les balades et rêve de trouver une famille", family_friendly: true, cat_friendly: true, main_quality:"Sportif", is_adopted: false)
    ...
    pet6 = Pet.create!(name: "Shelby", age: "09/03/2014", race: "Cavalier King Charles", gender: "femelle", shelter_id: fourth_shelter.id, category: "chien", description:"Shelby est une très gentille chien, câline et attachante, qui globalement s’entend plutôt bien avec ses congénères", main_quality:"Joueuse", family_friendly: true, cat_friendly: true, is_adopted: false)
    ...
    pet7 = Pet.create!(name: "Lola", age: "21/06/2018", race: "Bichon", gender: "femelle", shelter_id: fourth_shelter.id, category: "chien", description: "Lola est une chienne adorable, qui adore les câlins et les cours d'agility", main_quality:"Espiègle", family_friendly: true, cat_friendly: true, is_adopted: false)
  ...
  puts "Dogs created"
    ...
    pet3 = Pet.create!(name: "Titeuf", age: "01/01/2008", race: "Européen", gender: "mâle", shelter_id: fifth_shelter.id, category: "chat", description: "Titeuf est une magnifique minette indépendante. Elle aura besoin de temps pour faire confiance.", main_quality:"Espiègle", family_friendly: true, cat_friendly:true, is_adopted: false)
    ...
    pet7 = Pet.create!(name: "Yoshi", age: "01/06/2022", race: "Européen", gender: "mâle", shelter_id: first_shelter.id, category: "chat", description: "C'est un chat sociable qui s'adaptera facilement à son nouveau foyer. Un extérieur serait un plus pour lui.", main_quality:"Doux avec les enfants", family_friendly: true, cat_friendly:true, is_adopted: false)
    ...
    pet8 = Pet.create!(name: "Musti", age: "01/12/2021", race: "Européen", gender: "femelle", shelter_id: second_shelter.id, category: "chat", description: "C'est un chat sociable qui s'adaptera facilement à son nouveau foyer.", main_quality:"Joueur",  family_friendly: true, cat_friendly:true, is_adopted: false)
    ...
    pet10 = Pet.create!(name: "Rouka", age: "25/07/2022", race: "Européen", gender: "mâle", shelter_id: third_shelter.id, category: "chat", description: "C'est un chat sociable qui s'adaptera facilement à son nouveau foyer.", main_quality:"Affectueux", family_friendly: true, cat_friendly: true, is_adopted: false)
